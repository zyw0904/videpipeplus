...
#include "../nodes/infers/vp_mobilenet_edgetpu_face_node.h"
...
int main() {
    ...
    //Py_SetPythonHome(L"/usr/lib/python3.9");
    Py_Initialize();
    if(!Py_IsInitialized()){
    ...
    auto yunet_face_detector_0 = std::make_shared<vp_nodes::vp_mobilenet_edgetpu_face_node>("yunet_face_detector_0", "/home/zyw/video_pipe_c-pure_cpu/models/mobilenet_ssd_v2_face_quant_postprocess_edgetpu.tflite", "");
    //auto sface_face_encoder_0 = std::make_shared<vp_nodes::vp_face_landmarks_node>("face_landmarks_0", "/home/zyw/models/lbfmodel.yaml");
