...
int main() {
    ...
    // create nodes
    auto file_src_0 = std::make_shared<vp_nodes::vp_file_src_node>("file_src_0", 0, "/home/zyw/test_video-20230505T093512Z-001/test_video/face.mp4",0.6);
    
    auto yunet_face_detector_0 = std::make_shared<vp_nodes::vp_mobilenet_edgetpu_object_node>("yunet_face_detector_0", "/home/zyw/桌面/uhiivuwshd.onnx","", "", "");
