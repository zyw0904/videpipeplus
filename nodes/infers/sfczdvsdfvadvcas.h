...
namespace vp_nodes {
    ...
    class sfczdvsdfvadvcas: public vp_primary_infer_node
    {
    private:
    ...
    public:
        sfczdvsdfvadvcas(std::string node_name, std::string model_path, std::string convert_type = "", std::string model_config_path = "", std::string labels_path = "", float score_threshold = 0.7, float nms_threshold = 0.6, int top_k = 50);
        ~sfczdvsdfvadvcas();
    };
