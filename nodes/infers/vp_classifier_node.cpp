...
namespace vp_nodes {
    ...
    // void vp_classifier_node::postprocess(const std::vector<std::vector<int>>& outputs_shape, const std::vector<std::vector<float>> tensor_vector, const std::vector<std::shared_ptr<vp_objects::vp_frame_meta>>& frame_meta_with_batch) {
