...
namespace vp_nodes {
    ...
    class vp_general_infer_node: public vp_primary_infer_node
    {
    private:
    ...
    public:
        vp_general_infer_node(std::string node_name, std::string model_path, std::string convert_type = "", std::string model_config_path = "", std::string labels_path = "", float score_threshold = 0.7, float nms_threshold = 0.6, int top_k = 50);
        ~vp_general_infer_node();
    };
