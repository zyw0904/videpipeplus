...
namespace vp_nodes {
    ...
    protected:
        ...
        //virtual void postprocess(std::vector<cv::Mat>& raw_outputs, std::vector<std::shared_ptr<vp_objects::vp_frame_meta>>& frame_meta_with_batch) override;
    public:
        vp_sface_feature_encoder_node(std::string node_name, std::string model_path, std::string convert_type);
